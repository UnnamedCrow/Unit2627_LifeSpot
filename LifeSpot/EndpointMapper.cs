...
namespace LifeSpot
{
    public static class EndpointMapper
    {
        ...
        /// <summary>
        /// Маппинг картинок для слайдера
        /// </summary>
        public static void MapImages(this IEndpointRouteBuilder builder)
        {
            var imgFiles = new[] { "01.jpg", "02.jpg","03.jgg","04.jpg","05.jpg"};

            foreach (var fileName in imgFiles)
            {
                builder.MapGet($"Views/Shared/Pictures/{fileName}", async context =>
                {
                    var imgPath = Path.Combine(Directory.GetCurrentDirectory(), "Views","Shared", "Pictures", fileName);
